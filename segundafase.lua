...
ball.isBullet=true
local ob31 = display.newRect(90,0,15,100)
local ob32 = display.newRect(210,0,15,100)
local ob33 = display.newRect(90,102,135,15)
local ob34 = display.newRect(90,119,135,15)
physics.addBody(ob31,{density =3})
physics.addBody(ob32,{density =3})
physics.addBody(ob33,{density =3})
physics.addBody(ob34,{density =3})
screenGroup:insert(ob31)
screenGroup:insert(ob32)
screenGroup:insert(ob33)
screenGroup:insert(ob34)
...
function  handleButtonEvent( event )
	storyboard.gotoScene( "terceirafase", "slideLeft", 1100  )
...
function scene:enterScene( event )
	...
	storyboard.purgeScene( "primeirafase" )
end

--Runtime:addEventListener( "enterFrame", rotateObstacle)
